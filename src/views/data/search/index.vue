          ...
          <div style="width: 1500px">
            <a-input-group>
              <a-select
                ...
                :style="{ width: '160px', marginRight: '5px', height: '50px' }"
                placeholder="请选择搜索类型"
              />
              <a-input
                v-model="searchQuery"
                ...
                allow-clear
                style="margin-right: 5px; width: 1150px; height: 50px"
                @input="handleInput"
              ...
              <a-button type="primary" style="height: 50px; width: 90px"
                >搜索</a-button
              >
              <a-button type="text" @click="higherSearch">高级搜索</a-button>
            </a-input-group>
...
<!--                </a-row>-->
                ...
                <a-form :model="form" layout="horizontal" labelCol="{ span: 4 }" wrapperCol="{ span: 14 }" v-if="selectValue === '人物名称'">
                  <a-row>
                    <a-col :span="8">
                ...
                <a-form :model="form" layout="horizontal" labelCol="{ span: 4 }" wrapperCol="{ span: 14 }" v-if="selectValue === '组织名称'">
                  <a-row>
                    <a-col :span="8">
                ...
                <a-form :model="form" layout="horizontal" labelCol="{ span: 4 }" wrapperCol="{ span: 14 }" v-if="selectValue === '社交账号'">
                  <a-row>
                    <a-col :span="8">
                ...
                <a-form :model="form" layout="horizontal" :labelCol="{ span: 8 }" :wrapperCol="{ span: 16 }" v-if="selectValue === '邮箱账号'">
                  <a-row>
                    <a-col :span="8">
                ...
                <a-form :model="form" layout="horizontal" :labelCol="{ span: 8 }" :wrapperCol="{ span: 16 }" v-if="selectValue === '邮件名称'">
                  <a-row>
                    <a-col :span="8">
                ...
                <a-form :model="form" layout="horizontal" :labelCol="{ span: 8 }" :wrapperCol="{ span: 16 }" v-if="selectValue === '新闻数据'">
                  <a-row>
                    <a-col :span="8">
