    ...
    <div class="left-content" style="float: left; width: 50%;">
      ...
      <div class="left-left-content" style="float: left; width: 20%;">
        <a-space size="large" direction="vertical">
          <a-space size="large">
          <a-avatar :size="100" shape="square">Arco</a-avatar>
        </a-space>
      </a-space>
    </div>
    <div class="left-right-content" style="float: left; width: 80%;">
      ...
      <a-row>
        <a-col :span="24">
          <h3>个人简历</h3>
          <!-- <p>{{ info.resume }}</p> --><p>这是一段简历。。。。。。简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历简历</p>
        </a-col>
      </a-row>
      <!-- 相关新闻 -->
      <a-divider class="mt-0"/>
