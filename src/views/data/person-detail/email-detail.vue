      ...
      <a-row>
        ...
        <a-col :span="10">
          <a-space direction="horizontal">
            <a-form-item field="name" label="收件人" style="margin-right: 30px">
              <a-select :style="{ width: '150px' }" placeholder="请选择收件人">
                <a-option>111</a-option>
                <a-option>222</a-option>
                <a-option>333</a-option>
                <a-option disabled>Disabled</a-option>
              </a-select>
            </a-form-item>
            <a-form-item field="name" label="发件人">
              <a-select :style="{ width: '150px' }" placeholder="请选择发件人">
                <a-option>11111</a-option>
                <a-option>22222</a-option>
                <a-option>33333</a-option>
                <a-option disabled>Disabled</a-option>
              </a-select>
            </a-form-item>
